    ...
    <div className="relative min-h-screen flex flex-col text-white overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-md bg-black/50 p-8 rounded-3xl border border-green-400/40 shadow-[0_0_25px_rgba(34,197,94,0.6)] animate-fadeIn backdrop-blur-md">
          <h2 className="text-3xl font-bold mb-6 text-center text-green-400 tracking-wide animate-pulse">Forgot Password</h2>
          ...
          <div className="mt-4 text-center text-green-300 text-sm">
            Remembered password?{" "}
            <span className="text-green-400 hover:underline cursor-pointer" onClick={() => navigate("/")}>Login</span>
          </div>
          <div className="mt-2 text-center text-green-300 text-sm">
            New user?{" "}
            <span className="text-green-400 hover:underline cursor-pointer" onClick={() => navigate("/signup")}>Sign Up</span>
          </div>
        </div>
      </div>
    </div>
